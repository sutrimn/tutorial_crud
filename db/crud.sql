...
CREATE TABLE `buah` (
  `idbuah` int(11) NOT NULL AUTO_INCREMENT,
  `buahNama` varchar(45) DEFAULT NULL,
  `buahJumlah` int(11) DEFAULT NULL,
  PRIMARY KEY (`idbuah`)
...
INSERT INTO `buah` VALUES (7,'Apel',6),(8,'Anggur Merah',34);
...
-- Dump completed on 2019-05-10 13:09:29
